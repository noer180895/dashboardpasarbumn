            ...
            <div class="row">
                <div class="col-sm-4 col-md-3">
                    ...
                    <div class="sidber-box cats-price">
                        ...
                        <span style="padding-left: 27px;"><b>Sorting results by your options</b></span><hr />


                        <!-- <div class="price-Pips"> -->
                            <div class="col-sm-6">
                                <label class="price-radio">&nbsp; Highest Price
                                  <input type="radio" checked="checked" name="price">
                                  <span class="checkmark"></span>
                                </label>

                                <label class="price-radio">&nbsp; Lowest Price
                            ...
                            <div class="col-sm-6">
                                 ...
                                 <label class="price-radio">&nbsp; Review Score
                                  <input type="radio"  name="price">
                                  <span class="checkmark"></span>
                                </label>

                                <label class="price-radio">&nbsp; Popularity
                                  <input type="radio"  name="price">
                                  <span class="checkmark"></span>
                                </label>
                            </div>
                    ...
                    <div class="sidber-box cats-facility">
                        ...
                        <div class="facility">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span> Pet allowed
                                </label>
                            </div>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span> Fitness center
                                </label>
                            </div>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span> Restaurant
                                </label>
                            </div>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span> Tour guides
                                </label>
                            </div>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span> Groups allowed
                                </label>
                            </div>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" value="">
                                    <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span> Parking
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-3 col-md-4 hidden-xs">
                                <div class="input-group custom-search">
                                    <input type="text" class="form-control" placeholder="Search Your Hotel">
                            ...
                            <div class="col-sm-3 col-md-4 hidden-xs">
                                  <select class="form-control" id="room" name="room">
                                            <option value="" selected>Per room, per night</option>
                    ...
                    <div class="hotel-list-content">
                        ...
                        <div class="hotel-item">
                            ...
                            <div class="hotel-image">
                                <a href="<?php echo base_url(); ?>product/hotel_detail/<?php echo $data->productId; ?>">
