<div class="content-wrapper">
    <section class="content-header">
      <h1>
        <i class="fa fa-list"></i>  List Data Item
      </h1>
    </section>
    <br />
                                ...
                                <form action="#" id="form" class="form-horizontal">
                                    ...
                                    <div class="form-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input name="kode_item" placeholder="Kode Item" class="form-control" type="text">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3">Jenis Item</label>
                                            <div class="col-md-9">
...
function edit_item(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="jenis_item"]').val(data.jenis_item);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('item/ajax_add')?>";
    } else {
...
function delete_item(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('item/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
